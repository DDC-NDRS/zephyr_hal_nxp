...
#define ADC_SAR_IP_STATUS_FLAG_ALL                                                                                     \
    (ADC_SAR_IP_STATUS_FLAG_NORMAL_EOC | ADC_SAR_IP_STATUS_FLAG_NORMAL_ENDCHAIN |                                      \
     ADC_SAR_IP_STATUS_FLAG_INJECTED_EOC | ADC_SAR_IP_STATUS_FLAG_INJECTED_ENDCHAIN | ADC_SAR_IP_STATUS_FLAG_CTU_EOC | \
     ADC_SAR_IP_STATUS_FLAG_CALIBRATED | ADC_SAR_IP_STATUS_FLAG_NORMAL_STARTED |                                       \
     ADC_SAR_IP_STATUS_FLAG_INJECTED_STARTED | ADC_SAR_IP_STATUS_FLAG_INJECTED_ABORTED |                               \
     ADC_SAR_IP_STATUS_FLAG_CTU_STARTED | ADC_SAR_IP_STATUS_FLAG_AUTOCLOCKOFF)
#define ADC_SAR_IP_NOTIF_FLAG_ALL                                                                                      \
    (ADC_SAR_IP_NOTIF_FLAG_NORMAL_EOC | ADC_SAR_IP_NOTIF_FLAG_NORMAL_ENDCHAIN | ADC_SAR_IP_NOTIF_FLAG_INJECTED_EOC |   \
     ADC_SAR_IP_NOTIF_FLAG_INJECTED_ENDCHAIN | ADC_SAR_IP_NOTIF_FLAG_CTU_EOC)
...
#define ADC_SAR_IP_CHAN_NOTIF_FLAG_ALL (ADC_SAR_IP_CHAN_NOTIF_EOC | ADC_SAR_IP_CHAN_NOTIF_WDG)
