...
/*!
 * @file S32K358_CMU_FC.h
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_CMU_FC
 *
...
#if !defined(S32K358_CMU_FC_H_)  /* Check if memory map has not been already included */
#define S32K358_CMU_FC_H_
...
#endif  /* #if !defined(S32K358_CMU_FC_H_) */
