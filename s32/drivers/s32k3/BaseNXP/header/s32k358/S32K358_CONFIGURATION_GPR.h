...
/*!
 * @file S32K358_CONFIGURATION_GPR.h
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_CONFIGURATION_GPR
 *
...
#if !defined(S32K358_CONFIGURATION_GPR_H_)  /* Check if memory map has not been already included */
#define S32K358_CONFIGURATION_GPR_H_
...
typedef struct {
  ...
  __I  uint32_t QSPI_SFP_CTRL;                     /**< QuadSPI SFP Control, offset: 0xC0 */
...
#endif  /* #if !defined(S32K358_CONFIGURATION_GPR_H_) */
