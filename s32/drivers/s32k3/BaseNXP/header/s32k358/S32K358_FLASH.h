...
/*!
 * @file S32K358_FLASH.h
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_FLASH
 *
...
#if !defined(S32K358_FLASH_H_)  /* Check if memory map has not been already included */
#define S32K358_FLASH_H_
...
#define FLASH_MCRE_n2M_MASK                      (0xE0000000U)
#define FLASH_MCRE_n2M_SHIFT                     (29U)
#define FLASH_MCRE_n2M_WIDTH                     (3U)
#define FLASH_MCRE_n2M(x)                        (((uint32_t)(((uint32_t)(x)) << FLASH_MCRE_n2M_SHIFT)) & FLASH_MCRE_n2M_MASK)
/*! @} */
...
#define FLASH_SSPELOCK_SSPELOCK_MASK             (0xFFFFFFFU)
#define FLASH_SSPELOCK_SSPELOCK_SHIFT            (0U)
#define FLASH_SSPELOCK_SSPELOCK_WIDTH            (28U)
...
#define FLASH_XSSPELOCK_XSSPELOCK_MASK           (0xFFFFFFFU)
#define FLASH_XSSPELOCK_XSSPELOCK_SHIFT          (0U)
#define FLASH_XSSPELOCK_XSSPELOCK_WIDTH          (28U)
...
#endif  /* #if !defined(S32K358_FLASH_H_) */
