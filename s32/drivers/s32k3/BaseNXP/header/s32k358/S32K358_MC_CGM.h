...
/*!
 * @file S32K358_MC_CGM.h
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_MC_CGM
 *
...
#if !defined(S32K358_MC_CGM_H_)  /* Check if memory map has not been already included */
#define S32K358_MC_CGM_H_
...
typedef struct {
  ...
  __IO uint32_t MUX_13_DC_0;                       /**< Clock Mux 13 Divider 0 Control Register, offset: 0x648 */
  uint8_t RESERVED_15[48];
  __I  uint32_t MUX_13_DIV_UPD_STAT;               /**< Clock Mux 13 Divider Update Status Register, offset: 0x67C */
...
#define MC_CGM_MUX_5_DC_0_DIV_MASK               (0x3F0000U)
#define MC_CGM_MUX_5_DC_0_DIV_SHIFT              (16U)
#define MC_CGM_MUX_5_DC_0_DIV_WIDTH              (6U)
...
#define MC_CGM_MUX_13_DC_0_DIV_MASK              (0x10000U)
#define MC_CGM_MUX_13_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_13_DC_0_DIV_WIDTH             (1U)
...
#define MC_CGM_MUX_14_DC_0_DIV_MASK              (0x10000U)
#define MC_CGM_MUX_14_DC_0_DIV_SHIFT             (16U)
#define MC_CGM_MUX_14_DC_0_DIV_WIDTH             (1U)
...
#endif  /* #if !defined(S32K358_MC_CGM_H_) */
