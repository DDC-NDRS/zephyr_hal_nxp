 ...
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_PLL
 *
...
#if !defined(S32K358_PLL_H_)  /* Check if memory map has not been already included */
#define S32K358_PLL_H_
...
#define IP_PLL_BASE_ADDRS                        { IP_PLL_BASE, IP_PLL_AUX_BASE }
/** Array initializer of PLL peripheral base pointers */
#define IP_PLL_BASE_PTRS                         { IP_PLL, IP_PLL_AUX }
...
#define PLL_PLLODIV_DIV_MASK                     (0xFF0000U)  /* Merged from fields with different position or width, of widths (5, 8), largest definition used */
#define PLL_PLLODIV_DIV_SHIFT                    (16U)
#define PLL_PLLODIV_DIV_WIDTH                    (8U)
#define PLL_PLLODIV_DIV(x)                       (((uint32_t)(((uint32_t)(x)) << PLL_PLLODIV_DIV_SHIFT)) & PLL_PLLODIV_DIV_MASK)  /* Merged from fields with different position or width, of widths (5, 8), largest definition used */
...
#endif  /* #if !defined(S32K358_PLL_H_) */
