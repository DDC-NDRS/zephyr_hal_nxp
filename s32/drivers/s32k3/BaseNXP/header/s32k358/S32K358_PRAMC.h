...
/*!
 * @file S32K358_PRAMC.h
 * @version 1.1
 * @date 2022-10-01
 * @brief Peripheral Access Layer for S32K358_PRAMC
 *
...
#if !defined(S32K358_PRAMC_H_)  /* Check if memory map has not been already included */
#define S32K358_PRAMC_H_
...
#define IP_PRAMC_2_BASE                          (0x40468000u)
/** Peripheral PRAMC_2 base pointer */
#define IP_PRAMC_2                               ((PRAMC_Type *)IP_PRAMC_2_BASE)
/** Array initializer of PRAMC peripheral base addresses */
#define IP_PRAMC_BASE_ADDRS                      { IP_PRAMC_0_BASE, IP_PRAMC_1_BASE, IP_PRAMC_2_BASE }
/** Array initializer of PRAMC peripheral base pointers */
#define IP_PRAMC_BASE_PTRS                       { IP_PRAMC_0, IP_PRAMC_1, IP_PRAMC_2 }
...
#endif  /* #if !defined(S32K358_PRAMC_H_) */
